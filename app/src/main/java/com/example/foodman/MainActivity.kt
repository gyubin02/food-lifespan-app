...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            requestNotificationPermissionIfNeeded()//푸시알림권한 요청
            ...
            findViewById<ImageView>(R.id.bottom_bell).setOnClickListener {
                supportFragmentManager.beginTransaction()
            ...
            val testData = workDataOf(
                "foodName" to "테스트 식재료",
                "fridgeName" to "2025-06-24",
                "dayOffset" to 0 // (변수명 맞게! daysBefore → dayOffset)
            )
